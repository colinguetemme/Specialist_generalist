...
one_simul(amplitude, period, stoch_magnitude, strength_selec, mut_rate, num_loci, t_max)
```
...
But from this point we clearly require optimisation or going to another language, that is why this code has been translated to C++
